...
namespace culebrita
{
    class ProgramColaListaEnlazada
    {
        ...
        private static bool MoverLaCulebrita(Metodo4 culebra, Point posiciónObjetivo,
            int longitudCulebra, Size screenSize)
        {
            var lastPoint = (Point)culebra.FinadeCOla();
            ...
            {
                var removePoint = (Point)culebra.SuprimirValor();
                Console.BackgroundColor = ConsoleColor.Black;
        ...
        private static Point MostrarComida(Size screenSize, Metodo4 culebra)
        {
            var lugarComida = Point.Empty;
            var cabezaCulebra = (Point)culebra.FinadeCOla();
            var rnd = new Random();
