...
namespace snake
{
    class pcc
    {
        ...
        private static bool MoverLaCulebrita(Metodo2 culebra, Point posiciónObjetivo, //aqui
            int longitudCulebra, Size screenSize)
        {
            ...
            {
                var removePoint = (Point)culebra.Cancelar(); //aqui
                Console.BackgroundColor = ConsoleColor.Black;
        ...
        private static Point MostrarComida(Size screenSize, Metodo2 culebra)
        {
