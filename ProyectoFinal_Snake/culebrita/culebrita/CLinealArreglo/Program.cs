...
namespace snake
{
    class pca
    {
        ...
        private static bool MoverLaCulebrita(lclarr.Metodo3 culebra, Point posiciónObjetivo,
            int longitudCulebra, Size screenSize)
        {
            var lastPoint = (Point)culebra.FinaldeCola();
        ...
        private static Point MostrarComida(Size screenSize, lclarr.Metodo3 culebra) //aqui
        {
            var lugarComida = Point.Empty;
            var cabezaCulebra = (Point)culebra.FinaldeCola(); //aqui
            var rnd = new Random();
        ...
        public void Main()
        {
            ...
            var culebrita = new lclarr.Metodo3();
